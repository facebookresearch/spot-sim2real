...
INSTRUCTIONS = (
    "Use 'wasdqe' for translating gripper, 'kmhjyu' for rotating.\n"
    ...
    "Logging:\n"
    "\t Press 'r' to rotate the robot in place while collecting data \n"
    "\t Press 'l' to enable & disable datalogging with base control \n"
    "Press 'z' to quit.\n"
)
