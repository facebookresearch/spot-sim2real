...
def show_image(nparr):
    ...
    if nparr.dtype == np.float32:
        nparr = (255.*nparr).astype(np.uint8)
...
def start_publishing():
    ...
    publisher = ros.Publisher("/new_image_pub", "sensor_msgs/Image", verbose=True) #std_msgs/Float32MultiArray "sensor_msgs/Image"
...
if __name__ == "__main__":
    ...
    subscriber = ros.Subscriber("/new_image_pub", "sensor_msgs/Image", callback_fn=show_image, verbose=True)
    #time.sleep(0.5)
