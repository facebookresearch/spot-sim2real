        ...
        if self.spotskillmanager.nav_config.READ_HUMAN_ACTION_FROM_ROS_PARAM:
            ...
            if (
                ...
                if action == "pick":
                    ...
                    msg = f"Human has placed the {object_name}, and please make sure the placement location is correct"
            ...
            if self._human_action != human_activity_current:
                ...
                if action == "pick":
                    ...
                    msg = "Human has placed the object, and please make sure the placement location is correct"
