...
class SpotRobotSubscriberMixin:
    ...
    def __init__(self, spot=None, *args, **kwargs):
        ...
        # Setting the timer to get images or warn timeout exceeded
    ...
    # Letting the user know about timeout to get images. This function lets the user know time taken to get the topics
    ...
    # Added Try-catch statement to debug errors from processing robot state
