...
if __name__ == "__main__":
    ...
    while contnue:
        ...
        ) = orientationsolver.perform_orientation_correction(
            spot, spinal_axis, gamma, object_name
        )
        # breakpoint()
        # rospy.set_param("is_gripper_blocked", 0)
        ...
        print(
            f"Correction Status {correction_status}, Putback status {put_back_object_status}"
        )
